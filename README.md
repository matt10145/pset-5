...
TODO:
- update inputs for #4 --> check if its a valid triangle AFTER we define the types of sides
- review every other exercise
- @mrwilson I had a problem with the canceling (pressing it returned 0) is this valid?
